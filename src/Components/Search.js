      ...
      <div className="p-4   rounded-lg  mt-4">
          <div className="grid grid-cols-4 gap-4 mb-4"> 
            <div className="flex items-center justify-center h-24 rounded bg-gray-100 dark:bg-gray-100">
                ...
                <p className="ml-2 text-sm text-gray-400 dark:text-gray-500">Partners<br/><span className='text-2xl  font-bold'>2,456</span></p>
            </div>
            <div className="flex items-center justify-center h-24 rounded bg-gray-50 dark:bg-gray-100">
                {<AiOutlineShop size={48} fill='#6A0DAD'/>}
                <p className="ml-2 text-sm text-gray-400 dark:text-gray-500">Employed<br/><span className='text-2xl  font-bold'>3,236</span></p>
            </div>
            <div className="flex items-center justify-center h-24 rounded bg-gray-50 dark:bg-gray-100">
            ...
            <div className="flex items-center justify-center h-24 rounded bg-gray-50 dark:bg-gray-100">
                ...
                <p className="ml-2 text-sm text-gray-400 dark:text-gray-500">Candidates<br/><span className='text-2xl  font-bold'>1,000</span></p>
